...
const ValueProposition = () => {
    return(
        <>
            <div id="how" className="min-h-[300px] bg-darkest border-b-0 border-dashed border-gray-400 w-full relative overflow-hidden pt-20 px-5 md:px-20 md:pt-40 md:pb-20 pb-10 ">
                ...
                The process involves 3 easy & straightforward steps. Yeah, that simple!
                </p>
                <div className="w-full pt-10 mt-5 gap-10 sm:gap-5 md:gap-10 lg:gap-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="p-1 rounded-xl drop-shadow-12xl bg-gradient-to-br from-darker to-darker hover:from-fancy hover:to-fancy">
                        <div className="bg-darker h-full w-full box-border group px-8 py-10 rounded-lg">
                            <div className="rounded-full bg-fancy text-center flex items-center justify-center text-[35px] lg:text-[40px] font-bold text-darkest h-[50px] w-[50px] lg:h-[60px] lg:w-[60px] mx-0 ">1</div>
                            <h3 className="font-semibold text-white text-2xl mt-5 leading-[1.1] ">Come up with a session idea</h3>
                            <p className="text-gray-400 text-lg font-light mt-5 group-hover:text-gray-400 text-justify">Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio </p>
                        </div>
                    </div>
                    ...
                    <div className="p-1 rounded-xl drop-shadow-12xl bg-gradient-to-tl from-darker to-darker hover:from-fancy hover:to-fancy">
                        <div className="bg-darker h-full w-full box-border group px-8 py-10 rounded-lg">
                            <div className="rounded-full bg-fancy text-center flex items-center justify-center text-[35px] lg:text-[40px] font-bold text-darkest h-[50px] w-[50px] lg:h-[60px] lg:w-[60px] mx-0 ">2</div>
                            <h3 className="font-semibold text-white text-2xl mt-5 leading-[1.1] ">Pick up an option which matches your needs</h3>
                            <p className="text-gray-400 text-lg font-light mt-5 group-hover:text-gray-400 text-justify">Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio </p>
                        </div>
                    </div>
...
<div className="col-span-2 bg-darker bg-gradient-to-tr from-darker to-darker rounded-lg max-h-[450px] drop-shadow-12xl overflow-hidden">
    <img src="https://images.pexels.com/photos/4340785/pexels-photo-4340785.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" className="w-full object-cover"/>
...
<div className="col-span-2 bg-darker bg-gradient-to-bl from-darker to-darker rounded-lg max-h-[450px] drop-shadow-12xl overflow-hidden">
    <img src="https://images.pexels.com/photos/733853/pexels-photo-733853.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" className="w-full object-cover"/>
                    ...
                    <div className="p-1 rounded-xl drop-shadow-12xl bg-gradient-to-bl from-darker to-darker hover:from-fancy hover:to-fancy">
                        <div className="bg-darker h-full w-full box-border group px-8 py-10 rounded-lg">
                            <div className="rounded-full bg-fancy text-center flex items-center justify-center text-[35px] lg:text-[40px] font-bold text-darkest h-[50px] w-[50px] lg:h-[60px] lg:w-[60px] mx-0 ">3</div>
                            <h3 className="font-semibold text-white text-2xl mt-5 leading-[1.1] ">Next, tell me about your idea</h3>
                            <p className="text-gray-400 text-lg font-light mt-5 group-hover:text-gray-400 text-justify">Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio </p>
                        </div>
                    </div>
                    ...
                    <div className="p-1 rounded-xl drop-shadow-12xl bg-gradient-to-tl from-darker to-darker hover:from-fancy hover:to-fancy">
                        <div className="bg-darker h-full w-full box-border group px-8 py-10 rounded-lg">
                            <div className="rounded-full bg-fancy text-center flex items-center justify-center text-[35px] lg:text-[40px] font-bold text-darkest h-[50px] w-[50px] lg:h-[60px] lg:w-[60px] mx-0 ">4</div>
                            <h3 className="font-semibold text-white text-2xl mt-5 leading-[1.1] ">I will get back to discuss the overall concept</h3>
                            <p className="text-gray-400 text-lg font-light mt-5 group-hover:text-gray-400 text-justify">Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio Check out my portfolio my portfolio my portfolio </p>
                        </div>
                    </div>
