...
const About = () => {
    return(
        <div id='about' className=" bg-darkest z-20 w-full flex relative justify-center overflow-hidden items-center py-20 md:pt-60 md:pb-60">
            <div className="absolute left-0 top-0 bottom-0 -right-[50%] bg-darkless -rotate-[230deg] -z-20"></div>
            <div className="w-[80%] max-w-6xl px-0 py-0 flex flex-col relative box-border shadow-glow rounded-lg">
                    <img className=" sm:absolute -bottom-16 -z-10 -left-16 w-72" src="/images/dots.png" alt="bottom dots" />
                    <img className=" sm:absolute -top-16 -z-10 -right-16 w-72" src="/images/dots.png" alt="top dots" />
                ...
                <div className="w-full flex flex-col lg:flex-row bg-darkest px-0 py-14 rounded-lg">
                    ...
                    <div className="flex flex-col text-left w-full lg:w-4/6 border-l-0 lg:border-l-2 border-l-text-secondary border-t-2 lg:border-t-0 border-t-text-secondary box-border pl-14 pr-14 lg:pl-14 lg:pr-10">
                        <h2 className="text-3xl font-bold text-text-primary mt-10 md:mt-0">About me</h2>
                        <p className=" text-text-secondary text-xl font-light mt-5">I am an enthusiastic, self-motivated, reliable, responsible and hard working person. 
                        ...
                        <span className=" text-text-primary text-lg font-medium mt-5">Follow me on Instagram:</span> 
                        <img 
