      ...
      >
        ...
        <div className="w-full rounded-xl mt-12 flex flex-col lg:flex-row nowrap overflow-hidden">
          <div className="w-full lg:w-4/6 bg-gray-50 p-7 md:p-10">
            ...
            <div
              className="grid grid-cols-1 sm:grid-cols-2 h-auto md:grid-cols-5 md:rounded-md w-full md:h-14 lg:h-14 mb-7"
              role="group"
            >
              <button
                onClick={handleClick}
                ...
                className={`${
                  currentTab === "Ladies Formal"
                    ? "ring-4 ring-darkest z-10 bg-white"
                    : "bg-white"
                } md:w-full px-2 py-3 text-sm font-normal 
              ...
              <button
                ...
                className={`${
                  currentTab === "Ladies Casual"
                    ? "ring-4 ring-darkest z-10 bg-white"
                    : "bg-white"
                } w-full px-2 py-3 text-sm font-normal text-gray-500 
          ...
          <div className="w-full lg:w-2/6 md:min-w-[380px] p-7 md:p-10 pt-0 lg:p-10 bg-white border-t-2 lg:border-t-0 lg:border-l-2 border-gray-100">
            <h2 className="text-2xl font-bold text-left mt-8 md:mt-0 lg:mt-0 mb-5">
            ...
            <div className="w-full grid grid-cols-2 ">
              ...
              <div className="bg-white text-right font-medium">
                {currentSession.moodBoard ? "included" : "not included"}
              </div>
              <div className=" bg-white text-left font-light">Ideas</div>
              <div className="bg-white text-right font-medium">
                {currentSession.ideas ? "included" : "not included"}
              </div>
              <div className=" bg-white text-left font-light">Raw Photos</div>
              <div className=" bg-white text-right font-medium">
                {currentSession.photosRaw} pieces
              </div>
              <div className=" bg-white text-left font-light">Tuned Photos</div>
              <div className=" bg-white text-right font-medium">
                {currentSession.photosTuned} pieces
              </div>
              <div className=" bg-white text-left font-light">
                Extra hour rate
              </div>
              <div className=" bg-white text-right font-medium">
                {currentSession.extraHourRate} / hour
              </div>
              <div className="mb-2 bg-white text-left font-light">
                Session Duration
              </div>
              <div className="mb-2 bg-white text-right font-medium">
