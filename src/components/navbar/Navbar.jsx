...
const Navbar = () => {
    ...
    return(
        ...
        <nav className="bg-darkest shadow-lg fixed top-0 left-0 z-50 w-full h-24 flex flex-row items-center justify-between px-10">
            <span className="text-text-primary font-light text-4xl font-dream">
                    T<span className="text-fancy">o</span>r<span className="text-fancy">o</span>nt<span className="text-fancy">o</span><span className="text-fancy">.</span>
            </span>
            <div className="flex flex-row flex-nowrap">
                <ScrollSpy duration={2000}>
                    <a className={`text-text-primary border-transparent border-b-4 border-t-4 px-4 hover:border-b-fancy py-2 transition-border duration-300`} href="#services" ref={React.createRef()}>Services</a>
                    <a className={`text-text-primary border-transparent border-b-4 border-t-4 px-4 hover:border-b-fancy py-2 transition-border duration-300`} href="#about" ref={React.createRef()}>About</a>
                    <a className={`text-text-primary border-transparent border-b-4 border-t-4 px-4 hover:border-b-fancy py-2 transition-border duration-300`} href="#portfolio" ref={React.createRef()}>Portfolio</a>
                    <a className={`text-text-primary border-transparent border-b-4 border-t-4 px-4 hover:border-b-fancy py-2 transition-border duration-300`} href="#how" ref={React.createRef()}>How</a>
                    <a className={`text-text-primary border-transparent border-b-4 border-t-4 px-4 hover:border-b-fancy py-2 transition-border duration-300`} href="#rates" ref={React.createRef()}>Rates</a>
                    <a className=" text-center text-[16px] rounded-md border-transparent bg-fancy py-1.5 px-4 transition-border duration-300 border-4 font-normal text-darkest ml-5" href="#contact" ref={React.createRef()}>Contact me</a>
                </ScrollSpy>
